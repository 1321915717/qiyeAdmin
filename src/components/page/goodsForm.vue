            ...
            <div class="form-box">
                <el-form ref="form"  label-width="80px">
                    ...
                    <el-form-item label="分类">
                        <el-cascader :options="options" v-model="option"></el-cascader>
                    </el-form-item>
...
<script>
	...
	import { findcategoryAll,Goodsinsert} from '../../api/index';
...
export default {
    ...
    methods: {
        ...
        onSubmit() {
			...
			Goodsinsert(video,lun,img,title,content,cid,type).then(res=>{
				if(res.errno==0){
